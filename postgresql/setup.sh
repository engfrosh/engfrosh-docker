...
docker exec postgres psql -U postgres -d engfrosh_dev_2022_07_05 -c "GRANT ALL ON ALL TABLES IN SCHEMA public TO engfrosh_site"
docker exec postgres psql -U postgres -d engfrosh_dev_2022_07_05 -c "GRANT ALL ON ALL TABLES IN SCHEMA public TO engfrosh_bot"
